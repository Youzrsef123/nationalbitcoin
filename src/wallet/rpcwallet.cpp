...
static UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    const WitnessV0KeyHash *pkhash = boost::get<WitnessV0KeyHash>(&dest);
    if (!pkhash) {
...
static UniValue loadwallet(const JSONRPCRequest& request)
{
            RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting nationalbitcoind will be"
    ...
    if (!options.isNull()) {
      if (options.type() == UniValue::VBOOL) {
        ...
        if (options.exists("change_type")) {
            ...
            coinControl.m_change_type = OutputType::BECH32;
        ...
        return NullUniValue;
            ...
            "                                                         getaddressinfo output fields for the embedded address, excluding metadata (timestamp, hdkeypath,\n"
                            ...
                            "as an array to keep the API stable if multiple labels are enabled in the future.",
                        {
                            ...
                            {RPCResult::Type::OBJ, "", "label data, DEPRECATED, will be removed in 0.21. To re-enable, launch nationalbitcoind with `-deprecatedrpc=labelspurpose`",
                            {
