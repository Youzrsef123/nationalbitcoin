...
bool Intro::showIfNeeded(interfaces::Node& node, bool& did_show_intro, bool& prune)
{
     ...
     * override -datadir in the nationalbitcoin.conf file in the default data directory
...
void Intro::UpdatePruneLabels(bool prune_checked)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the National Bitcoin block chain.").arg(PACKAGE_NAME) + " " +
