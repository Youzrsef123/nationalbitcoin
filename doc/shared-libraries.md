...
## nationalbitcoinconsensus

The purpose of this library is to make the verification functionality that is critical to National Bitcoin's consensus available to other applications, e.g. to language bindings.

### API

The interface is defined in the C header `nationalbitcoinconsensus.h` located in `src/script/nationalbitcoinconsensus.h`.
